...
class ChildOfDerived extends  Derived1{
    ...
    ChildOfDerived(int x, int y) {
        super(x,y);
        System.out.println("I am a crazy child of derived class constructor");
    }
...
public class construct_inherit{
    public static void main(String[] args) {
        // Base1 b = new Base1();
        // Derived1 d = new Derived1();
        // Derived1 dc = new Derived1(14, 9);
        // ChildOfDerived cd1 = new ChildOfDerived();
        ChildOfDerived cd = new ChildOfDerived(12, 13);
        cd.toString();   // just ignore this statement
    }
}
